  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
        className="flex mx-4 flex-col gap-8 mt-8"
        >
        <div
        className="flex flex-col md:flex-row  gap-4"
        >
          
          <p className="text-white max-w-1/2 w-full md:w-1/2 text-justify ">
          ...
          <div
            className="max-w-1/2  w-full md:w-1/2 max-h-[320px] lg:max-h-[200px]"
            >
                <img
        ...
        >
            <div
            className="max-w-1/2 w-full md:w-1/2 max-h-[330px] hidden md:block lg:max-h-[200px]"
            >
                <img
          ...
          <p
          className="max-w-1/2 w-full md:w-1/2 text-justify text-white"
          >
