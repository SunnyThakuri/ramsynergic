...
import AustraliaProcess from './AustraliaProcess'
      ...
      <div className="all">
        <div className="img xl:pt-[146px] lg:pt-[140px] sm:pt-[100px] pt-[80px] 2xl:mx-[91px] xl:mx-[95px] lg:mx-[70px] md:mx-[50px] mx-[10px]">
          ...
          <div className="absolute xl:pt-[104px] lg:pt-[80px] sm:pt-[50px] pt-[20px] xl:ml-[85px] lg:ml-[60px] sm:ml-[40px] ml-[20px]">
            <h1 className='text-white  lg:text-[32px] sm:text-[22px]  text-[16px] font-Poppins font-semibold ' >Australia</h1>
            <div className=" flex">
              ...
              <h1 className='text-gray-400 font-Poppins sm:text-[16px] text-[12px]'> / Australia</h1>
            </div>
          </div>
        ...
        <div className="subintro md:flex md:justify-between 2xl:mx-[166.5px] xl:mx-[100px] lg:mx-[80px] md:mx-[50px] sm:mx-[20px] mx-[10px] mt-[50px]">
          ...
          <div className="left_side lg:mt-[42px] xl:w-[663px] lg:w-[500px] md:w-[400px]">
            ...
            <h1 className='text-justify'>Hungary's diverse and thriving economy offers a wide range of job opportunities across various sectors, including manufacturing, information technology, finance, healthcare, and tourism.</h1>
