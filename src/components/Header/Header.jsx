  ...
  return (
    <>
      <div
        ...
        } shadow-md bg-[#F7F7F7] w-screen z-[20000] 2xl:px-[166.5px] xl:px-[100px] md:px-[80px] md:px-[50px] sm:px-[80px] px-[20px] flex justify-between`}
      >
          ...
          <div onClick={() => handleClick("Home")}>
            <NavLink to="/">
              <div className="nav_logo flex ">
                <img
                  className="sm:w-[123.5px] w-[100px] sm:h-[42px] h-[32px] md:mt-[27px] mt-5"
                  src={navlogo}
        ...
        <div
          onClick={toggleMenu}
          className="menu cursor-pointer md:hidden md:pt-[33px] pt-5"
        >
  ...
  return (
    <>
      <div
        className={`all_header ${
          isScrolled ? "fixed" : "relative"
        } shadow-lg bg-[#F7F7F7] w-screen z-[20000] 2xl:px-[166.5px] xl:px-[100px] lg:px-[80px] md:px-[50px] sm:px-[80px] px-[20px] flex justify-between`}
      >
        <div className="left_side">
          <div onClick={() => handleClick("Home")}>
            <NavLink to="/">
        ...
        <div
          ref={menuRef}
          onClick={toggleMenu}
          className="Navigation  lg:relative absolute right-0 lg:w-auto w-[80%] lg:h-auto"
        >
          <div className="right_side  text-[#828282] font-Poppins lg:mt-[33px] lg:space-x-[32px] lg:flex lg:bg-inherit bg-white h-screen lg:h-auto pb-[10px]">
            ...
            <NavLink to="/">
              <h1
                className={`lg:border-none border-b-[1px] border-gray-400 lg:pl-0 pl-5 lg:mt-auto mt-5 ${getTextClasses(
                  "Home"
                )}`}
                onClick={() => handleClick("Home")}
              >
            ...
            <NavLink to="/about">
              <h1
                className={`lg:border-none border-b-[1px] border-gray-400 lg:pl-0 pl-5 lg:pt-0 pt-3 lg:pb-0 pb-3 ${getTextClasses(
                  "About"
                )}`}
                onClick={() => handleClick("About")}
              >
        ...
        <div
          onClick={toggleMenu}
          className="menu cursor-pointer lg:hidden md:pt-[33px] pt-5"
        >
          <i className="fa-solid fa-bars text-[25px]"></i>
        </div>
      </div>
