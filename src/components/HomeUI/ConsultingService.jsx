  ...
  return (
    <>
      <div className="ConsultingService mt-[150px] 2xl:mx-[166.5px] xl:mx-[100px] lg:mx-[80px] md:mx-[50px] sm:mx-[20px] mx-[10px] md:flex md:justify-between font-Poppins">
        ...
        <div className="">
          <h1 className="lg:text-[32px] md:text-[25px] text-[32px]  text-[#14213A] font-semibold md:w-[334px] text-center md:mx-0 sm:mx-[100px] mx-[10px]">Global Connect
