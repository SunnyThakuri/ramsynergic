...
function FaqCustom() {
    ...
    const handleSubmit=async(event)=> {
        ...
        const res= await axios.post("https://global-server-kappa.vercel.app/service/form",formdata)
  ...
  return (
    <div className="rounded-lg">
      <div className="flex flex-col items-center justify-center rounded-lg ">
        <div className="w-12 h-12 relative -mb-6 shadow-xl  z-10  bg-white rounded-full">
          <img src="/ourservices/profile.svg" className=" w-full h-full object-cover z-10 absolute"/>
        </div>
