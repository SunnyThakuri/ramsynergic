...
import number from "../../assets/ServiceUI/003.png";
      ...
      <div className="all md:flex justify-between 2xl:mx-[166.5px] xl:mx-[100px] lg:mx-[80px] md:mx-[50px] sm:mx-[20px] mx-[10px]  md:pt-[202px] pt-[120px]">
        <div className="left_side hidden md:block">
          <img
            ...
            src={manpowersolutionImg1}
            alt=""
          />
          <img
            className="lg:w-[237px] w-[200px] h-[340px] ml-[80px]"
            src={manpowersolutionImg2}
            alt=""
          />
        </div>
        ...
        <div className="right_side">
          ...
          <h1 className="text-[#333333] xl:w-[550px] lg:w-[400px] md:w-[320px] mt-[12px] md:ml-[25px] sm:mx-0 mx-[10px]">
            We specialize in delivering customized workforce solutions tailored
            to meet the specific needs of our clients, aiming to streamline
            operations, drive efficiency, and maximize productivity across
            various facets of the organization.
          </h1>

          <ul className="list-disc xl:w-[433px] lg:w-[400px] md:w-[300px] mt-5 sm:ml-12 ml-8">
            <li>
              Flexible, scalable staffing models to adapt to business needs
            </li>
            <li>
              Comprehensive training & development programs to upskill employees
            </li>
            <li>
              Robust performance management systems for continuous improvement
            </li>
